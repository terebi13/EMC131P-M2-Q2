export default class OverScene extends Phaser.Scene{
    ...
    init (data) { // get data score from gamescene
     ...
     preload () {
        ...
        this.load.image('bgscore', "../assets/images/bgscore.png");
        ...
        this.load.audio('over_sfx', '../assets/sfx/loose.mp3');

     }

     create () {
        this.add.image(500,400, 'background').setScale(1.0);
        this.add.image(500, 400, 'bgscore').setScale(1.0);
        ...
        this.add.text(580, 310, ' ' + this.finalScore, {font: 'bold 90px Arial Black', fill:'#BB4115' });
